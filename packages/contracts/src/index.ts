...
export const authDrivers = ["local", "supabase"] as const;
export const dataDrivers = ["memory", "supabase"] as const;
export const queueDrivers = ["inline", "trigger"] as const;
export const aiDrivers = ["minimax", "openai", "anthropic", "mock"] as const;
...
export type AuthDriver = (typeof authDrivers)[number];
export type DataDriver = (typeof dataDrivers)[number];
export type QueueDriver = (typeof queueDrivers)[number];
export type AiDriver = (typeof aiDrivers)[number];
...
export const StrategyReportSchema = z.object({
  ...
  sections: z.array(StrategySectionSchema).min(2).max(8),
...
export const ActiveMemoryContextResponseSchema = z.object({
  memoryContext: ActiveMemoryContextSchema.nullable(),
});

export type ActiveMemoryContextResponse = z.infer<typeof ActiveMemoryContextResponseSchema>;

export const ApiErrorSchema = z.object({
  error: z.string(),
  message: z.string(),
  provider: z.enum(aiDrivers).optional(),
